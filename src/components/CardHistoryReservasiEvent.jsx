import { Box, Badge, Text, VStack, HStack, Divider, Flex, Button } from "@chakra-ui/react";
import dayjs from "dayjs";
import { CopyToClipboard } from "react-copy-to-clipboard";
import { FaCopy } from "react-icons/fa";
import { useToast } from "@chakra-ui/react";
const CardHistoryReservasiEvent = ({reservasi}) => {
  ...
  return (
    ...
    >
      <VStack spacing={4}>
        ...
        <Badge bgColor={"brand.utama"} color={"white"}>  {reservasi.judul}</Badge>
        ...
        <HStack>
          ...
          <Text>{reservasi.pembayaran.virtual_account}</Text>
          <CopyToClipboard
            text={reservasi.pembayaran.virtual_account}
            onCopy={() => {
              toast({
...
export default CardHistoryReservasiEvent
